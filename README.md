...
Print the 3D Printed Dashboard file in this repo. I suggest printing 2 so you have some spare flat plastic you can use for this next step. Plastic weld to hold the microcontroller. (FYI I suck at 3d print design, I included the source file in case you want to change it in Free Cad)<br>
